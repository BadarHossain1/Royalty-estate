    ...
    return (
        <div>
            <Swiper pagination={{
                ...
                modules={[Pagination]} className="mySwiper  w-full h-[500px]  ">
                <SwiperSlide><div className="bg-cover bg-center   w-full h-full flex items-center justify-center " style={{ backgroundImage: "url('https://i.ibb.co/JzSWXp9/mansion-1.jpg')", backgroundColor: "rgba(0, 0, 0, 0.65)" }}>
                    <p className="text-4xl  md:text-7xl shadow-xl font-extrabold font-playfair-display text-[#fff]  text-center" >Discover Your Dream Home <br />
                ...
                <SwiperSlide>
                    <div className="bg-cover bg-center  bg-[url('https://i.ibb.co/db4660F/mansion-2.jpg')] w-full h-full flex items-center justify-center ">
                        <p className="text-4xl  md:text-7xl shadow-xl font-extrabold font-playfair-display text-[#fff] text-center" >Discover Your Dream Home <br />
                            in the Lap of Luxury</p>
