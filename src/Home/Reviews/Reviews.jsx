        ...
        <div >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-auto gap-5">
                ...
                <div className="card w-[90%] mx-auto lg:w-96 bg-base-100 shadow-2xl p-8 ">
                    ...
                    <p className=" font-normal  mt-6">
                        Working with Luxury Estates was a dream come true. Their team provided unparalleled support and expertise throughout the entire buying process. From identifying our needs to negotiating the deal, they demonstrated a level of commitment and integrity that made us feel confident every step of the way
                    </p>
                    <div className="rating rating-sm  mt-5">
                        <input type="radio" name="rating-6" className="mask mask-star-2 bg-orange-400" />
                        <input type="radio" name="rating-6" className="mask mask-star-2 bg-orange-400" />
                ...
                <div className="card w-[90%] mx-auto  lg:w-96  bg-base-100 shadow-2xl p-8 ">
                    ...
                    <p className=" font-normal  mt-6">
                        Our experience with Luxury Estates was nothing short of extraordinary. From the moment we connected with their team, we were impressed by their personalized approach and deep knowledge of the luxury real estate market. They went above and beyond to find us the perfect property.
                    </p>
                    <div className="rating rating-sm  mt-5">
                        <input type="radio" name="rating-6" className="mask mask-star-2 bg-orange-400" />
                        <input type="radio" name="rating-6" className="mask mask-star-2 bg-orange-400" />
