...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 bg-black text-base-content rounded relative">
                ...
                <aside>
                    <p className="text-white font-playfair-display font-semibold">Copyright © 2024 - All right reserved by Badar Hossain</p>
                </aside>
            </footer>
        </div>
    );
